...
public class RouteController {
    ...
    @GetMapping("/routes/calculate/nearest-shelter")
    public ResponseEntity<Route> calculateRouteToNearestShelter(
            @RequestParam double userLat,
            @RequestParam double userLon) {
        try {
            Route route = routeService.findRouteToNearestShelter(userLat, userLon);
            return ResponseEntity.ok(route);
        } catch (Exception e) {
            logger.error("Error calculating route to nearest shelter: {}", e.getMessage());
    ...
    @GetMapping(path = "/routes/calculate")
    ...
    @PostMapping(path = "/routes/recalculate")
    ...
    @PutMapping(path = "/routes/node/{nodeId}/unsafe")
    ...
    @PutMapping(path = "/routes/node/{nodeId}/safe")
    ...
    @GetMapping(path = "/routes/nodes/all")
    ...
    @GetMapping(path = "/routes/nodes/safe")
    ...
    @GetMapping(path = "/routes/nodes/area")
    ...
    @DeleteMapping(path = "/routes/cache/cleanup")
    ...
    @GetMapping(path = "/routes/evacuation")
    ...
    @PostMapping(path = "/routes/network/status")
